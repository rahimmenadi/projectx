...
let orderslist = [];
function sendorderid(k){
    localStorage.setItem('productIdSeller',orderslist[k]._id);
            ...
            <div onclick="sendProductId(${i})" class="items">
                ...
                <div class="foot-items">
                    <div class="prices">
                        ...
                        <div class="old-price">${orderslist[i].price} USD</div>
                    </div>
                    <div class="review">
...
filter_price.addEventListener("click" , ()=>{
    ...
    axios.get('https://buy-it-sigma.herokuapp.com/api/v1/seller/products?sortby=price', {
        headers: {
...
filter_quantity.addEventListener("click" , ()=>{
    ...
    filter_price.style.backgroundColor="white";
        axios.get('https://buy-it-sigma.herokuapp.com/api/v1/seller/products?sortby=quantity', {
            headers: {
                Authorization: `Bearer ${token}`
              }})
        .then(response => {
